...
QUESTIONS: list[str] = [
    ...
    "What did your hands smell like the last time you cooked?",
    ...
    "What temperature is the room you are in right now?",
    "Describe the taste of your favorite drink without naming it.",
    ...
    "Describe the feeling of the floor under your feet right now.",
    "What is a phrase you overuse without meaning to?",
    "What is the last thing you procrastinated on?",
    "Describe a color you would never paint a wall.",
